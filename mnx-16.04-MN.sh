#!/bin/bash
# Nodetrade Masternode Setup Script V3.1.0 for Ubuntu 16.04 LTS
#
...
echo -e "${GREEN} ------- Nodetrade MASTERNODE INSTALLER V3.1.0--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/IDCHAINGROUP/MNX/releases/download/v3.1.0/mnx-3.1.0-16.04-ubuntu-daemon.tar.gz
tar -xzvf mnx-3.1.0-16.04-ubuntu-daemon.tar.gz
...
sleep 7
    ...
    nodetrade-cli stop
    sleep 5
cd ~/.nodetrade && rm -rf blocks chainstate evodb sporks
cd ~/.nodetrade && wget https://github.com/IDCHAINGROUP/MNX/releases/download/v3.1.0/bootstrap.zip

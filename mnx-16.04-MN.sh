#!/bin/bash
# Nodetrade Masternode Setup Script V2.0.0 for Ubuntu 16.04 LTS
#
...
echo -e "${GREEN} ------- Nodetrade MASTERNODE INSTALLER V2.0.0--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/IDCHAINGROUP/MNX/releases/download/v2.0.0/mnx-2.0.0-16.04-ubuntu-daemon.tar.gz
tar -xzvf mnx-2.0.0-16.04-ubuntu-daemon.tar.gz
...
cd ~/.nodetrade && wget https://github.com/IDCHAINGROUP/MNX/releases/download/v2.0.0/bootstrap.zip
